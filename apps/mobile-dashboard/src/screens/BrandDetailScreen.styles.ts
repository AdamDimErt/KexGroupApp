...
export const styles = StyleSheet.create({
  ...
  // Расходы выделены красным — чтобы сразу было видно негатив
  heroExpenses: { color: colors.red, fontSize: 12, fontWeight: '500' },
  // PnL стили удалены — блок убран из UI до подключения 1С (см. BrandDetailScreen.tsx).
  // Sparkline area — занимает всю ширину карточки минус padding
  heroSparkWrap: { marginTop: 10, marginBottom: 4 },
  // List
