...
Use template from `D:/kexgroupapp/.claude/get-shit-done/templates/UI-SPEC.md`.
...
Read template: `D:/kexgroupapp/.claude/get-shit-done/templates/UI-SPEC.md`
...
```bash
node "D:/kexgroupapp/.claude/get-shit-done/bin/gsd-tools.cjs" commit "docs($PHASE): UI design contract" --files "$PHASE_DIR/$PADDED_PHASE-UI-SPEC.md"
```
