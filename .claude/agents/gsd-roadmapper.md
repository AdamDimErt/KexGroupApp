...
Reference full template: `D:/kexgroupapp/.claude/get-shit-done/templates/roadmap.md`

## STATE.md Structure

Use template from `D:/kexgroupapp/.claude/get-shit-done/templates/state.md`.
